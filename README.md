...
1) Клонируйте репозиторий с помощью команды git clone https://github.com/AdelAbzalova/t-bank-exam.git <название папки>
...
https://abzalovaadelexamtbank.netlify.app/

## Описание проекта 
Была создана веб-страница с резюме, страница сверстана адаптивно, добавлена возможность редактирования текстовых элементов, все изменения анимированы, при перезагрузке страницы все изменения сохраняются, реализована кнопка "Скачать", которая преобразует текущую версию резюме в формат PDF и начинает загрузку файла на компьютер пользователя, добавлен эффект "Material Wave". Подробное описание задачи находится ниже.
